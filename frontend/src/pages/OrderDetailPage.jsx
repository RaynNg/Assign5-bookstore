  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <span className={`ml-auto px-4 py-2 rounded-full font-medium ${getStatusColor(order.status)}`}>
          ...
          <div className="flex items-center justify-between">
            {orderSteps.map((step, index) => (
              <div key={step.status} className="flex items-center">
                <div className={`flex flex-col items-center ${index < getCurrentStep() ? 'text-primary-600' : 'text-gray-400'}`}>
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    index < getCurrentStep() ? 'bg-primary-600 text-white' : 'bg-gray-200'
                  }`}>
                ...
                {index < orderSteps.length - 1 && (
                  <div className={`w-12 sm:w-24 h-1 mx-2 ${
                    index < getCurrentStep() - 1 ? 'bg-primary-600' : 'bg-gray-200'
                  }`} />
                )}
              </div>
            ))}
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="font-semibold text-gray-800 text-lg mb-4">Sản phẩm</h2>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-800">{order.shipping_address || 'Không có'}</p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="font-semibold text-gray-800 text-lg mb-4">Tổng tiền</h2>
